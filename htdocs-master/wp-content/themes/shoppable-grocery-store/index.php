	...
	<div id="content" class="site-content">
		<div class="container">
			...
			if( class_exists( 'woocommerce' ) ) {
				get_template_part( 'template-parts/departments/departments' ); 
			}
			?>
			
			<!--Blog Views-->
			<?php get_template_part( 'template-parts/views/views' ); ?>

			<!--Blog Advert-->
			<?php get_template_part( 'template-parts/advert/advert' ); ?>
							...
							<?php
								if( get_theme_mod( 'enable_pagination', true ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'shoppable-grocery-store' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'shoppable-grocery-store' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'shoppable-grocery-store' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'shoppable-grocery-store' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'shoppable-grocery-store' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
