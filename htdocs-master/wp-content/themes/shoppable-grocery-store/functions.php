 ...
 *
 * @package Shoppable Grocery Store 1.0.0
 */

require get_stylesheet_directory() . '/inc/customizer/customizer.php';
require get_stylesheet_directory() . '/inc/customizer/loader.php';

if ( ! function_exists( 'shoppable_grocery_store_enqueue_styles' ) ) :
	/**
	 * @since Shoppable Grocery Store 1.0.0
	 */
	function shoppable_grocery_store_enqueue_styles() {
        require_once get_theme_file_path ( 'inc/wptt-webfont-loader.php');

		wp_enqueue_style( 'shoppable-grocery-store-style-parent', get_template_directory_uri() . '/style.css',
			array(
				'bootstrap',
				'slick',
				'slicknav',
...
//review check
	    wp_enqueue_style(
            'shoppable-grocery-store-google-fonts',
...
add_action( 'wp_enqueue_scripts', 'shoppable_grocery_store_enqueue_styles', 10 );
...
* @return array.
*/
function shoppable_grocery_store_get_pages(){
...
* @return array
*/
function shoppable_grocery_store_get_product_categories(){
