	...
	public function filter_control_args( $args, $wp_customize ) {
		if ( $args['settings'] === $this->args['settings'] ) {
			...
			$args['button_labels'] = wp_parse_args(
				$args['button_labels'],
				[
					'select'       => esc_html__( 'Select image', 'goldy-mex' ),
					'change'       => esc_html__( 'Change image', 'goldy-mex' ),
					'default'      => esc_html__( 'Default', 'goldy-mex' ),
					'remove'       => esc_html__( 'Remove', 'goldy-mex' ),
					'placeholder'  => esc_html__( 'No image selected', 'goldy-mex' ),
					'frame_title'  => esc_html__( 'Select image', 'goldy-mex' ),
					'frame_button' => esc_html__( 'Choose image', 'goldy-mex' ),
				]
			);
