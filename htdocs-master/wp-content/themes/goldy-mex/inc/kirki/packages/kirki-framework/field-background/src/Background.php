		...
		new \Kirki\Field\Color(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Color', 'goldy-mex' ),
		...
		new \Kirki\Field\Image(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Image', 'goldy-mex' ),
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Repeat', 'goldy-mex' ),
					'section'     => $args['section'],
					'default'     => isset( $args['default']['background-repeat'] ) ? $args['default']['background-repeat'] : '',
					'choices'     => [
						'no-repeat' => esc_html__( 'No Repeat', 'goldy-mex' ),
						'repeat'    => esc_html__( 'Repeat All', 'goldy-mex' ),
						'repeat-x'  => esc_html__( 'Repeat Horizontally', 'goldy-mex' ),
						'repeat-y'  => esc_html__( 'Repeat Vertically', 'goldy-mex' ),
					],
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Position', 'goldy-mex' ),
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Size', 'goldy-mex' ),
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'description' => esc_html__( 'Background Attachment', 'goldy-mex' ),
					'label'       => '',
