		...
		<div class="icons-wrapper">
			...
			<# } else { #>
				...
				var dashiconSections = {
					'admin-menu': '<?php esc_html_e( 'Admin Menu', 'goldy-mex' ); ?>',
					'welcome-screen': '<?php esc_html_e( 'Welcome Screen', 'goldy-mex' ); ?>',
					'post-formats': '<?php esc_html_e( 'Post Formats', 'goldy-mex' ); ?>',
					'media': '<?php esc_html_e( 'Media', 'goldy-mex' ); ?>',
					'image-editing': '<?php esc_html_e( 'Image Editing', 'goldy-mex' ); ?>',
					'tinymce': 'TinyMCE',
					'posts': '<?php esc_html_e( 'Posts', 'goldy-mex' ); ?>',
					'sorting': '<?php esc_html_e( 'Sorting', 'goldy-mex' ); ?>',
					'social': '<?php esc_html_e( 'Social', 'goldy-mex' ); ?>',
					'wordpress_org': 'WordPress',
					'products': '<?php esc_html_e( 'Products', 'goldy-mex' ); ?>',
					'taxonomies': '<?php esc_html_e( 'Taxonomies', 'goldy-mex' ); ?>',
					'widgets': '<?php esc_html_e( 'Widgets', 'goldy-mex' ); ?>',
					'notifications': '<?php esc_html_e( 'Notifications', 'goldy-mex' ); ?>',
					'misc': '<?php esc_html_e( 'Miscelaneous', 'goldy-mex' ); ?>'
				};
				#>
