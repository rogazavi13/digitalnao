...
class Dimensions extends Field {
	...
	public function init( $args = array() ) {
		...
		$labels = array(
			...
			'font-size'      => esc_html__( 'Font Size', 'goldy-mex' ),
			'font-weight'    => esc_html__( 'Font Weight', 'goldy-mex' ),
			'line-height'    => esc_html__( 'Line Height', 'goldy-mex' ),
			'font-style'     => esc_html__( 'Font Style', 'goldy-mex' ),
			'letter-spacing' => esc_html__( 'Letter Spacing', 'goldy-mex' ),
			'word-spacing'   => esc_html__( 'Word Spacing', 'goldy-mex' ),
			'top'            => esc_html__( 'Top', 'goldy-mex' ),
			'bottom'         => esc_html__( 'Bottom', 'goldy-mex' ),
			'left'           => esc_html__( 'Left', 'goldy-mex' ),
			'right'          => esc_html__( 'Right', 'goldy-mex' ),
			'center'         => esc_html__( 'Center', 'goldy-mex' ),
			'size'           => esc_html__( 'Size', 'goldy-mex' ),
			'spacing'        => esc_html__( 'Spacing', 'goldy-mex' ),
			'width'          => esc_html__( 'Width', 'goldy-mex' ),
			'height'         => esc_html__( 'Height', 'goldy-mex' ),
			'invalid-value'  => esc_html__( 'Invalid Value', 'goldy-mex' ),
		);
