...
class Typography extends Field {
	...
	public function init( $args = [] ) {
		...
		self::$std_variants = [
			[
				'value' => 'regular',
				'label' => __( 'Regular', 'goldy-mex' ),
			],
			[
				'value' => 'italic',
				'label' => __( 'Italic', 'goldy-mex' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'goldy-mex' ),
			],
			[
				'value' => '700italic',
				'label' => __( '700 Italic', 'goldy-mex' ),
			],
		];
		...
		self::$complete_variants = [
			...
			[
				'value' => '100',
				'label' => __( '100', 'goldy-mex' ),
			],
			[
				'value' => '100italic',
				'label' => __( '100 Italic', 'goldy-mex' ),
			],
			[
				'value' => '200',
				'label' => __( '200', 'goldy-mex' ),
			],
			[
				'value' => '200italic',
				'label' => __( '200 Italic', 'goldy-mex' ),
			],
			[
				'value' => '300',
				'label' => __( '300', 'goldy-mex' ),
			],
			[
				'value' => '300italic',
				'label' => __( '300 Italic', 'goldy-mex' ),
			],
			[
				'value' => '500',
				'label' => __( '500', 'goldy-mex' ),
			],
			[
				'value' => '500italic',
				'label' => __( '500 Italic', 'goldy-mex' ),
			],
			[
				'value' => '600',
				'label' => __( '600', 'goldy-mex' ),
			],
			[
				'value' => '600italic',
				'label' => __( '600 Italic', 'goldy-mex' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'goldy-mex' ),
			...
			[
				'value' => '800',
				'label' => __( '800', 'goldy-mex' ),
			],
			[
				'value' => '800italic',
				'label' => __( '800 Italic', 'goldy-mex' ),
			],
			[
				'value' => '900',
				'label' => __( '900', 'goldy-mex' ),
			],
			[
				'value' => '900italic',
				'label' => __( '900 Italic', 'goldy-mex' ),
			],
		];
	...
	private function add_sub_fields( $args ) {
		...
		if ( isset( $args['default']['font-family'] ) ) {
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Family', 'goldy-mex' ),
						'description' => '',
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Variant', 'goldy-mex' ),
						'description' => '',
		...
		if ( $font_size_field_specified || $color_field_specified ) {
			$group = [
				'font-size' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Font Size', 'goldy-mex' ),
					'is_specified' => $font_size_field_specified,
				],
				'color'     => [
					'type'         => 'react-colorful',
					'label'        => esc_html__( 'Font Color', 'goldy-mex' ),
		...
		if ( $text_align_field_specified || $text_transform_field_specified ) {
			$group = [
				'text-align'     => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Align', 'goldy-mex' ),
					'is_specified' => $text_align_field_specified,
					'choices'      => [
						'initial' => esc_html__( 'Initial', 'goldy-mex' ),
						'left'    => esc_html__( 'Left', 'goldy-mex' ),
						'center'  => esc_html__( 'Center', 'goldy-mex' ),
						'right'   => esc_html__( 'Right', 'goldy-mex' ),
						'justify' => esc_html__( 'Justify', 'goldy-mex' ),
					],
				],
				'text-transform' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Transform', 'goldy-mex' ),
					'is_specified' => $text_transform_field_specified,
					'choices'      => [
						'none'       => esc_html__( 'None', 'goldy-mex' ),
						'capitalize' => esc_html__( 'Capitalize', 'goldy-mex' ),
						'uppercase'  => esc_html__( 'Uppercase', 'goldy-mex' ),
						'lowercase'  => esc_html__( 'Lowercase', 'goldy-mex' ),
					],
				],
			];
		...
		if ( $text_decoration_field_specified ) {
			$group = [
				'text-decoration' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Decoration', 'goldy-mex' ),
					'is_specified' => $text_decoration_field_specified,
					'choices'      => [
						'none'         => esc_html__( 'None', 'goldy-mex' ),
						'underline'    => esc_html__( 'Underline', 'goldy-mex' ),
						'line-through' => esc_html__( 'Line Through', 'goldy-mex' ),
						'overline'     => esc_html__( 'Overline', 'goldy-mex' ),
						'solid'        => esc_html__( 'Solid', 'goldy-mex' ),
						'wavy'         => esc_html__( 'Wavy', 'goldy-mex' ),
					],
				],
			];
		...
		if ( $line_height_field_specified || $letter_spacing_field_specified ) {
			$group = [
				'line-height'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Line Height', 'goldy-mex' ),
					'is_specified' => $line_height_field_specified,
				],
				'letter-spacing' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Letter Spacing', 'goldy-mex' ),
		...
		if ( $margin_top_field_specified || $margin_bottom_field_specified ) {
			$group = [
				'margin-top'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Top', 'goldy-mex' ),
					'is_specified' => $margin_top_field_specified,
				],
				'margin-bottom' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Bottom', 'goldy-mex' ),
	...
	private function get_font_family_choices() {
		...
		$choices['default'] = [
			esc_html__( 'Defaults', 'goldy-mex' ),
			[
				'' => esc_html__( 'Default', 'goldy-mex' ),
			],
		];
		...
		$choices['standard'] = [
			esc_html__( 'Standard Fonts', 'goldy-mex' ),
			$std_fonts,
		];

		$choices['google'] = [
			esc_html__( 'Google Fonts', 'goldy-mex' ),
